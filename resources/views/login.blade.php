            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5 text-center">
                        ...
                        <h4 class="fs-13 fw-bold mb-2">Connectez vous a votre compte</h4>
                        ...
                        <form action="{{ route('dologin') }}" class="w-100 mt-4 pt-2" method="post">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="auth-reset-minimal.html" class="fs-11 text-primary">Mot de passe oublié?</a>
                                </div>
                            </div>
                            <div class="mt-5">
                                <button type="submit" class="btn btn-lg btn-primary w-100">Connexion</button>
                            </div>
                        </form>
